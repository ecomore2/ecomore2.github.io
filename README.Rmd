...
* [Tutiempo.net](https://en.tutiempo.net)'s daily meteorological data (4 stations, 2010-present): [CSV](https://raw.githubusercontent.com/ecomore2/meteo/master/data/meteo.csv) (948 KB), [description](https://ecomore2.github.io/meteo)
...
* [ESA](https://www.esa.int)'s
  [GlobCover](http://due.esrin.esa.int/page_globcover.php)'s land cover data (300-m resolution): 
...
* [EU](https://ec.europa.eu/jrc/en)'s
  [GHSL](https://ghsl.jrc.ec.europa.eu)'s built-up data (38-m resolution): [description](https://ecomore2.github.io/ghsl)
...
* [WorldPop](https://www.worldpop.org)'s population and urbanisation data (90-m resolution): [description](https://ecomore2.github.io/worldpop)
