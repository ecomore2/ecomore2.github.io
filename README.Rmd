...
* Meteorological data from [Tutiempo.net](https://en.tutiempo.net): [CSV](https://raw.githubusercontent.com/ecomore2/meteo/master/data/meteo.csv), [description](https://ecomore2.github.io/meteo)
* Built-up data from the [EU](https://ec.europa.eu/jrc/en)'s
[GHSL](https://ghsl.jrc.ec.europa.eu) project :
